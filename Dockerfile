...
RUN pip3 install debugpy pytest pytest-cov pytest-mock cython pylint pylint-exit black pre-commit
...
# install tman 
RUN wget --no-check-certificate --progress=dot:mega https://github.com/TEN-framework/ten_framework/releases/download/0.10.16/tman-linux-release-x64.zip && \
