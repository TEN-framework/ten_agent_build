...
RUN pip3 install debugpy pytest pytest-cov pytest-mock cython pylint pylint-exit
...
# install tman 
RUN wget --no-check-certificate --progress=dot:mega https://github.com/TEN-framework/ten_framework/releases/download/0.8.17/tman-linux-clang-release-x64.zip && \
